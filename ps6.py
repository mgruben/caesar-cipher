...
def get_story_string():
    ...
    """
    f = open("/home/human/edX/6.00.1x/Python Problem Sets/PS6 Ciphers/story.txt", "r")
    story = str(f.read())
    f.close()
    return story

WORDLIST_FILENAME = '/home/human/edX/6.00.1x/Python Problem Sets/PS6 Ciphers/words.txt'
...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for letter in lower_str:
            alpha_dict[letter] = lower_str[n % 26]
            n += 1
        for letter in upper_str:
            alpha_dict[letter] = upper_str[n % 26]
            n += 1
        return alpha_dict
    ...
    def apply_shift(self, shift):
        ...
        for char in self.message_text:
            if char in alpha_dict:
                self.shifted_message += alpha_dict[self.message_text[n]]
            else:
                self.shifted_message += char
            n += 1
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        for s in range(26):
            ...
            shifted_list = shifted_message.split(" ")
            valid_word_count = 0
